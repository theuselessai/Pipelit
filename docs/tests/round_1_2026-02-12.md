...
1. ~~**Consider:** Auto-unblock tasks when dependencies complete (1.2.5)~~ — **DONE** (commit `3ff4fe0`)
2. ~~**Consider:** RediSearch installation guide or fallback for `spawn_and_await` without `conversation_memory`~~ — **DONE** (documented in README.md Redis Setup section)
