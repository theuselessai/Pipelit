// Component types
export type ComponentType = "categorizer" | "router" | "extractor" | "ai_model" | "agent" | "switch" | "run_command" | "http_request" | "web_search" | "calculator" | "datetime" | "create_agent_user" | "platform_api" | "whoami" | "epic_tools" | "task_tools" | "spawn_and_await" | "workflow_create" | "aggregator" | "human_confirmation" | "workflow" | "code" | "code_execute" | "loop" | "wait" | "merge" | "filter" | "error_handler" | "output_parser" | "memory_read" | "memory_write" | "identify_user" | "trigger_telegram" | "trigger_webhook" | "trigger_schedule" | "trigger_manual" | "trigger_workflow" | "trigger_error" | "trigger_chat"
