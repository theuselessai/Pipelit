...
const COMPONENT_ICONS: Record<string, IconDefinition> = {
  ...
  create_agent_user: faUserPlus, platform_api: faPlug, whoami: faFingerprint,scheduler_tools: faCalendarDays, system_health: faHeartPulse, spawn_and_await: faRocket, workflow_create: faPenRuler, workflow_discover: faCompass,
