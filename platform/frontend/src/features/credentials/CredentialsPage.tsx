...
import { useCredentials, useCreateCredential, useDeleteCredential } from "@/api/credentials"
...
export default function CredentialsPage() {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    if (credType === "llm") detail = { api_key: apiKey, base_url: baseUrl }
          ...
          <Table>
            ...
            <TableBody>
              ...
              {credentials?.length === 0 && (
                <TableRow><TableCell colSpan={4} className="text-center py-8 text-muted-foreground">No credentials yet.</TableCell></TableRow>
              )}
            </TableBody>
          </Table>
        </CardContent>
