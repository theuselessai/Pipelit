...
SUB_COMPONENT_TYPES = {"ai_model", "run_command", "output_parser", "memory_read", "memory_write", "code_execute", "platform_api", "whoami", "spawn_and_await", "workflow_create", "workflow_discover", "scheduler_tools", "system_health", "skill"}
