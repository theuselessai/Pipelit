...
class Settings(BaseSettings):
    ...
    JWT_PRIVATE_KEY: str = ""  # PEM-encoded EC private key, generated by `plit init`
    AGENTGATEWAY_URL: str = ""  # e.g. http://localhost:4000
    AGENTGATEWAY_ENABLED: bool = True  # feature flag for gradual rollout (default ON; hard cutover)
    AGENTGATEWAY_DIR: str = ""  # path to agentgateway installation directory
